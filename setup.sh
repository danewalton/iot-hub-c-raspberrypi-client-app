...
pushd ../
if [ -d azure-iot-sample-source/azure-iot-sdk-c ]
then
    echo "Azure IoT repo already downloaded. Checking for submodules"
    cd azure-iot-sample-source/azure-iot-sdk-c/
    git pull origin master
    git submodule update --init --recursive
    cd ..
else
    echo "Downloading Azure IoT repo"
    mkdir azure-iot-sample-source
    cd azure-iot-sample-source
    git clone --recursive https://github.com/Azure/azure-iot-sdk-c.git
fi

pushd azure-iot-sdk-c/build_all/linux
./build.sh --no-make

pushd ../../cmake/iotsdk_linux
make

sudo make install

#Pop out of cmake dir
popd

#Pop out of iotsdk build dir
popd

#Pop out of sdk dir and back to sample dir
popd
